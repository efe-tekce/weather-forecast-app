...
function Forecast({ queryObject }) {
  ...
  return (
    <div className='result-card bg-blue-500 w-full rounded-md flex flex-col justify-center shadow-2xl text-center'>
      {cityObject && Object.keys(cityObject).length > 0 ? (
        <>
          ...
          <section className='weather-section'>
            ...
            />
            <p>
              {Math.round(cityObject.consolidated_weather.at(-1).the_temp)}°C
            </p>
          </section>
